...
const CMGoodsReturnMHTable = () => {
    const navigate = useNavigate();
         ...
         const {
           ...
           queryKey: ["MatchingCOMGoodsReturn", search, currentPage],
           queryFn: () =>
             getMatchingGRPO(
               `/goods-return/commercial/matching?${search.searchKey}=${search.searchValue}&perPage=12&page=${currentPage}`,
               setError,
               setTotalPage
             ),
            ...
            {!matchingGRPOlist?.length ? (
              ...
              matchingGRPOlist.map((matchingGRPO) => (
                <tr
                  ...
                  onClick={() =>
                    navigate(
                      `/sap/purchasing/goods-return-matching/details/${matchingGRPO.documentEntry}`
                    )
                  }
...
export default CMGoodsReturnMHTable