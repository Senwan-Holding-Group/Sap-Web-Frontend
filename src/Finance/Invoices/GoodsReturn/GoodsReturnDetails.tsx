...
const GoodsReturnDetails = () => {
    ...
    const {
      ...
      queryKey: ["goodsReturnDetails", id],
      queryFn: () => getActiveGRPObyDocEntry(`/goods-return/active/${id}`, setError),
    ...
    useEffect(() => {
      if (goodsReturn) {
        setdocLine(goodsReturn.documentLine);
      }
    }, [goodsReturn]);
  return (
    ...
    <div className="bg-white border  border-geantSap-gray-25 geantShadow h-full  rounded-xl flex flex-col justify-between">
        ...
        <div className="flex-1 w-full overflow-scroll py-6 px-4 flex flex-col gap-y-10">
          <div className="flex  min-w-[1288px]">
            <div className="flex w-[26.875rem] flex-col gap-y-6">
              ...
              <div className="flex flex-col gap-y-2 ">
                ...
                <span
                  ...
                  {goodsReturn?.documentDate?.split(" ")[0]}
                </span>
              </div>
              <div className="flex flex-col gap-y-2 ">
                <Label className="text-sm font-bold text-geantSap-black">
                ...
                <span
                  ...
                  {goodsReturn && numberWithCommas(goodsReturn.documentTotal)}
                </span>
              </div>
              <div className="flex flex-col gap-y-2 ">
                <Label className="text-sm font-bold text-geantSap-black">
            ...
            <div className="flex flex-col rounded-full w-[26.875rem] gap-y-6 ">
              ...
              <div className="flex flex-col gap-y-2  ">
                ...
                <span
                  className={`h-10 w-[21.188rem] text-nowrap overflow-x-scroll overflow-y-hidden ${
                    isEdit ? "bg-geantSap-gray-25 text-geantSap-gray-400" : ""
                  }  border border-geantSap-gray-50 p-2 rounded-lg`}>
                  {goodsReturn?.comments}
                </span>
              </div>
              <div className="flex flex-col gap-y-2 ">
                <Label className="text-sm font-bold text-geantSap-black">
            ...
            <div className="flex flex-col w-[26.875rem] gap-y-6 ">
              ...
              <div className="flex gap-x-4 mt-4 items-center font-normal text-base">
                ...
                <span id="createdby" className=" text-geantSap-black">
                  {goodsReturn?.administrativeData?.createdBy}
                </span>
              </div>
              <div className="flex gap-x-4  items-center font-normal text-base">
                ...
                <span id="createdon" className=" text-geantSap-black">
                  {goodsReturn &&
                    new Date(
                      goodsReturn?.administrativeData?.createdOn
                    ).toDateString()}
                </span>
              </div>
              <div className="flex gap-x-4  items-center font-normal text-base">
                ...
                <span id="Editedby" className=" text-geantSap-black">
                  {goodsReturn?.administrativeData?.editedBy}
                </span>
              </div>
              <div className="flex gap-x-4  items-center font-normal text-base">
                ...
                <span id="Editedon" className=" text-geantSap-black">
                  {goodsReturn &&
                    new Date(
                      goodsReturn?.administrativeData?.editedOn
                    ).toDateString()}
                </span>
              </div>
            </div>
          ...
          <Tabs defaultValue="item" className="min-w-max  ">
            ...
            <TabsContent
                ...
                value="attachment">
                <Attachments attachmentList={goodsReturn?.attachment}/>
      ...
      <div className="flex justify-end gap-x-4 p-6 border-t borde-geantSap-gray-50">
        {!isEdit ? (
          <>
            <Button
              disabled={goodsReturn?.status==="Closed"|| isFetching}
              type="button"
              onClick={(e) => {
                if (!isEdit) {
                  e.preventDefault();
            ...
            <CopyToAP disabled={isFetching} docEntry={id} title={"Copy to credit memo"}/>
          ...
          <>
            ...
            <Button
              ...
              onClick={() => {
                EditGRPOLine(
                  `/goods-return/active/${goodsReturn?.documentEntry}`,
                  docLine,
                  setdocLine,
                  setisSubmitting,
                  toast,
