...
const GoodsReturnMHDetails = () => {
    ...
    const {
      ...
      queryKey: ["matchingGoodsReturnDetails", id],
      queryFn: () =>
        getMatchingGRPOByDocEntry(`/goods-return/finance/matching/${id}`, setError),
...
export default GoodsReturnMHDetails